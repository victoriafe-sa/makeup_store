...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        if (produtoRepository.count() == 0) {
            ...
            produtoRepository.save(new Produto(null, "Esponja Blender Soft", 29.90, 200, "https://io.convertiez.com.br/m/novaeracosmeticos/shop/products/images/38696/medium/esponja-ruby-rose-feels-soft-blender-22453_22116.jpg?auto=format&fit=crop&w=400&q=80"));
